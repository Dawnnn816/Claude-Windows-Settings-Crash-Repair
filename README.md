## Claude 导致的 Windows 设置崩溃和闪退诊断与修复工具

**简体中文** | [English](README_EN.md)

一个完全本地运行的 Windows 工具，用于诊断并修复 Claude Desktop 异常启动项触发的 Windows“设置 -> 应用 -> 启动”页面卡死、崩溃和闪退问题，同时保留 Windows 设置应用重新注册功能，用于处理另一类已确认的设置组件注册异常。
